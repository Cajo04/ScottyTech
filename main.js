...
const linkedinCmd    = require('./commands/linkedin');
...
async function handleMessages(sock, update) {
    try {
        ...
        switch (cmd) {
            ...
            case 'linkedin':                    await linkedinCmd(sock,chatId,message,args); break;
            case 'song': case 'music':          await songCmd(sock,chatId,message,args); break;
            ...
            case 'autoviewstatus':              await autoviewstatusCmd(sock,chatId,message,args); break;
