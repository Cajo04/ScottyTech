...
module.exports = {
    ...
    // ── OxBot API (tiktok/facebook/instagram/twitter/linkedin) ────────
    OXBOT_KEY: process.env.OXBOT_KEY || 'oxb_06a6385a322fd10d6b28498d2e4ebd13ae6ba894f19b5c12',
    OXBOT_API: process.env.OXBOT_API || 'https://lecay.oxbot.name.ng/api',

    // ── Links ─────────────────────────────────────────────────────────
    CHANNEL_LINK: process.env.CHANNEL_LINK || 'https://whatsapp.com/channel/0029VbCuz94EwEjpo1O0aB0q',
